...
import com.ahmed.book_ws.backend.BookServiceImpl;
...
public class BackendConfiguration {
    ...
    @Bean
    public BookServiceImpl bookService(AggregateRepository<BookAggregate, BookCommand> bookAggregateRepository) {
        return new BookServiceImpl(bookAggregateRepository);
    }
}
